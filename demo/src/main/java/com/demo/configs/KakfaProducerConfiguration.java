 ...
 * 
 * @Configuration public class KakfaProducerConfiguration {
 * 
 * @Bean public ProducerFactory<String, Users> producerFactory() { Map<String,
 ...
 * 
 * 
 * @Bean public KafkaTemplate<String, Users> kafkaTemplate() { return new
