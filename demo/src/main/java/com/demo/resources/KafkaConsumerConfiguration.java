 ...
 * 
 * 
 * // @Bean // public ConsumerFactory<String, Users> userConsumerFactory() { //
 ...
 * StringDeserializer.class); //
 * config.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG,
 * JsonDeserializer.class); //// return new
 * DefaultKafkaConsumerFactory<>(config, new StringDeserializer(), //// new
 * JsonDeserializer<>(User.class)); // }
 * 
 * // @Bean // public ConcurrentKafkaListenerContainerFactory<String, Users>
 * userKafkaListenerFactory() { //
 * ConcurrentKafkaListenerContainerFactory<String, Users> factory = new
 * ConcurrentKafkaListenerContainerFactory<>(); //
